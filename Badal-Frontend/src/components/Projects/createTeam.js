...
function CreateTeam() {
  ...
  const handleAddTeam = async () => {
    try {
      ...
      const createSubgroupResponse = await axios.post(`http://10.8.0.13:5030/create-subgroup-with-users/${OrgGitID}`, {
      ...
      if (isP001Allowed) {
        ...
        const createTeamResponse = await axios.post('http://10.8.0.13:5030/create-team', createTeamPayload);
