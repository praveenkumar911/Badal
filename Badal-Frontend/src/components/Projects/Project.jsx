...
export const Project = () => {
  ...
  const handleSearch = () => {
    axios
      .get("http://10.8.0.13:5030/filter-project-DB", {
...
const handleSearchChange = (e) => {
  ...
  useEffect(() => {
    axios
      .get("http://10.8.0.13:5030/get-project-DB")
      .then((response) => {
 ...
 /*  useEffect(() => {
    if (projectdata.length > 0) { 
      ...
      axios.get('http://10.8.0.13:5030/get-img-url', { params: { orgIds: projectdata.map(project=> project.projectOwner) } })
        .then(response => {
