...
function EditTask1(props) {
  ...
  useEffect(() => {
    axios
      .post('http://10.8.0.13:5030/get-Taskby-id', { taskId })
      .then((response) => {
  ...
  const handleEditTask = (event) => {
    ...
    axios
      .put(`http://10.8.0.13:5030/edit-issue/${moduleGitLabID}/${issueIid}`, {
      ...
      .then(() => {
        ...
        axios
          .put('http://10.8.0.13:5030/edit-task-DB', {
            taskid: taskId,
            tasksdata: formData,
          })
          .then((response) => {
